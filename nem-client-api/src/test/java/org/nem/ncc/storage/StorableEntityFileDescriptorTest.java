...
public class StorableEntityFileDescriptorTest {
	...
	public void descriptorCannotBeCreatedAroundDirectory() {
		...
		ExceptionAssert.assertThrowsStorableEntityStorageException(
				v -> this.createDesciptor(ENTITY, TEST_FILE_DIRECTORY),
	...
	public void descriptorCannotBeCreatedAroundStorableEntityWithInvalidExtension() {
		// Assert:
		ExceptionAssert.assertThrowsStorableEntityStorageException(
				v -> this.createDesciptor(ENTITY, TEST_STORABLE_ENTITY_FILE_BAD_EXT),
	...
	public void descriptorCanBeCreatedAroundStorableEntityWithValidExtension() {
		...
		// Act:
		final StorableEntityFileDescriptor descriptor = this.createDesciptor(entity, file);
	...
	public void openReadCanOpenFileThatExists() throws IOException {
		// Arrange:
		final StorableEntityFileDescriptor descriptor = this.createDesciptor(ENTITY, TEST_STORABLE_ENTITY_FILE);
	...
	private StorableEntityFileDescriptor createDesciptor(final DefaultStorableEntity entity, final File file) {
