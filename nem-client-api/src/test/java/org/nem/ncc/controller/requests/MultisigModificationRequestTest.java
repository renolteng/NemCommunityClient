...
public class MultisigModificationRequestTest {
	...
	public void requestCanBeCreated() {
		...
		Assert.assertThat(request.getIssuerAddress(),IsEqual.equalTo(sender));
		Assert.assertThat(request.getAddedCosignatories(), IsEquivalent.equivalentTo(cosignatoryAddresses));
	...
	public void requestCanBeDeserializedWithAllParameters() {
		...
		Assert.assertThat(request.getIssuerAddress(),IsEqual.equalTo(Address.fromEncoded("a")));
