		...
		private static final Map<String, Code> NIS_ERROR_MAP = new HashMap<String, Code>() {
			{
				...
				this.put("FAILURE_DESTINATION_ACCOUNT_HAS_PREEXISTING_BALANCE_TRANSFER", TRANSACTION_REJECTED_DESTINATION_ACCOUNT_NON_EMPTY);
				...
				this.put("FAILURE_MULTISIG_ACCOUNT_CANNOT_BE_COSIGNER", MULTISIG_REJECTED_ALREADY_A_COSIGNER);
