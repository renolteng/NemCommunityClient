    ...
    texts: {
        ...
        modals: {
            ...
            createRealAccountData: {
                ...
                message: "Долните данни са за вашия реален акаунт след старта на NEM.Запазете адреса,публичния ключ и найважно частния ключ на сигурно място.Ако загубите частния си ключ вашият акаунт и всички реални NEMs ще бъдат загубени завинаги",
                address: "Адрес",
                ...
                recheck: {
                    ...
                    incorrect: {
                        title: "Хмм...",
                        message: "Частният ключ който току що въведохте не е правилен!Ммола проверете го отново и го въведете още един път."
                    },
                    recheck: "Проверка"
                },
                ok: "ОК"
