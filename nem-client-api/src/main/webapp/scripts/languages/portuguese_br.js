define({
    ...
    texts: {
        ...
        faults: {
            ...
            500: "ocorreu um erro que o time de desenvolvedores não havia previsto. Procure reiniciar o cliente. Caso não resolva, por favor, abra uma reclamação no fórum Nem descrevendo como ocorreu o problema. ",
