define({
	...
	texts: {
		faults: {
            ...
            600: 'За получаване и изпращане на транзакции NCC изисква NIS сървара да бъде рестартиран.Моля използвайте менюто на NCC за рестартиране в локалния възел.',
        ...
        common: {
        	...
        	nisStatus: {
        		...
        		synchronizing: 'NIS се синхронизира. В блок {{1}}, около {{2}} дни назад.'
        	}
        },
		modals: {
			error: {
