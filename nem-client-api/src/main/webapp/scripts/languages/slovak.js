define({
	...
	texts: {
		...
		faults: {
			...
			305: "Server infraštruktúry nie je dostupný.",
			...
			703: "Zostatok na vašom účte neumožňuje poslať zadané množstvo NEMov.",
				...
				sections: [
					...
					},
					{
						...
						paragraphs: [
							...
							"Čím silnejší je <strong>NIS</strong>, tým vyššia je bezpečnosť.",
