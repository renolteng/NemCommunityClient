define({
	...
	texts: {
		...
		faults: {
			...
			701: 'Het termijn ligt in het verleden en is alleen geldig binnen het tijdsbestek van 1 dag.',
			702: 'Het termijn ligt te ver in de toekomst en is alleen geldig binnen het tijdsbestek van 1 dag.',
			703: 'Uw rekening heeft niet genoeg balans om deze transactie te maken.',
			704: 'De tekst is te groot om het via NEM te verzenden. Reduceer de tekst en probeer het opnieuw te verzenden.',
			705: 'De kluts (hash) van de transactie bestaat al in de database van onbevestigde transacties.',
			706: 'De handtekening van de transactie kon niet worden geverifieerd.',
			707: 'De tijdsaanduiding van de transactie ligt te ver in het verleden.',
			708: 'De tijdsaanduiding van de transactie ligt te ver in de toekomst.',
			709: 'Het rekeningnummer is onbekend.  Een rekening wordt pas bekend op het netwerk als dit deel heeft uitgemaakt van een transactie (als verzender of ontvanger).',
			710: 'De transactie is geweigerd omdat het transactie cache vol zit. Een hogere toeslag bevordert de kans dat de transactie geaccepteerd wordt.',
			730: 'Belang overdrachtstransactie (gedelegeerd oogsten) komt in conflict met bestaande transactie.',
			731: 'De rekening van gedelegeerd oogsten heeft een saldo van nul en kan niet worden gebruikt.',
			732: 'Prioriteit overdracht geweigerd. Er is al een prioriteit overdracht in afwachting.',
			733: 'Gedelegeerd oogsten is al geactiveerd.',
			734: 'Gedelegeerd oogsten is NIET actief. Kan niet gedeactiveerd worden.',
			740: 'Transactie niet toegestaan voor multisig rekening.',
			741: 'De handtekening van deze multisig transactie is geweigerd. Geselecteerde rekening is geen handtekeninghouder van een multisig rekening.',
			742: 'De handtekening van deze multisig transactie is geweigerd. Geassocieerde multisig transactie is niet bekend bij het NEM netwerk.',
			743: 'Aanpassing van multisig rekening is geweigerd. Een van de toegevoegde rekeningen is al handtekeninghouder.',
